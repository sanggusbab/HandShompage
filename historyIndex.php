...
<head>
    ...
    <title>HandS History Page</title>
    ...
    <link rel="stylesheet" href="./cssIndexes/historyIndex/HistoryWrapper.css">
    ...
    <div class="relative">
        <div class="contentsContainer">
            <div id="contentsWrapper">
                <?php
                include_once $_SERVER['DOCUMENT_ROOT'] . '/include/historyIndex/contentsWrapper.php';
                ?>
            </div>
            <?php
