<div
    ...
    <div
        style="position: absolute; right:35px; width:430px; height:630px; background-color: #fff; box-shadow: 0 0 20px rgba(255, 255, 255, 0.9) ;float: right;border-radius: 15px; z-index:2">
