...
<div class="rows" >
    ...
    <div style="text-align: center; max-width: 80%; height: 300px; overflow: hidden;">
        <img src="images/etc/handshistorytimelinesample.png" alt="handshistorytimelinesample" class="handshistorytimelinesample"  style="margin:auto;">
    </div>
    <div style="text-align: center;">
        <p>
            <br>
...
<div class="rows">
    ...
    <div style="text-align: center;">
        <p>
            ...
            세미나, 스터디와 같은 교류활동에 자율성과 활동 편의성을 증진시킵니다!<br>
            <br>
            <br>
            <br>
        </p>
